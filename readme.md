...
Організація паралельного виконання декількох частин програми та порівняння з послідовною обробкою.

### Вимоги

Використовуючи програми рішень попередніх задач, продемонструвати ефективність паралельної обробки елементів контейнера.
